...
export const Config: React.FC = function Config() {
    ...
    return <div>
        Very High Items:<br/>
        Select several of your "Very High" popularity item until there is only one match left.<br/>
        ...
        <a href="https://github.com/CitySim/miqo" target="_blank">GitHub</a>
        &nbsp;&mdash;&nbsp;
        Discord: Yue#0034
        <br/>
        ...
        <ul>
            ...
            <li>thanks to this <a href="https://docs.google.com/spreadsheets/d/1e5dyaHSt5lj25l3nFWO5QcPmAJ2aAoPxCWj-iZnKxRk/edit#gid=1283864903" target="_blank">sheet</a> for the value formula</li>
        </ul>
    </div>;
}
